...
#include "gold/vectorArithmetics.cpp"
...
#include "algos/amazon/twosums.cpp"
#include "algos/amazon/lengthOfLongestSubstring.cpp"
#include "algos/amazon/MyAtoi.cpp"
#include "algos/amazon/maxArea.cpp"
#include "algos/amazon/firstUniqChar.cpp"
#include "algos/amazon/convertToWords.cpp"
#include "algos/amazon/IntToRoman.cpp"
#include "algos/amazon/romanToInt.cpp"
#include "algos/amazon/threeSum.cpp"
#include "algos/amazon/minimalHeaviestSetA.cpp"
#include "algos/amazon/numIslands.cpp"  
#include "algos/easy/diagonalDifference.cpp"
#include "algos/easy/plusMinus.cpp"
#include "algos/easy/TimeConversion.cpp"
using namespace std;
...
#undef main 
int main() { 
	int arr1[] = { 1, 1,0,-1,-1};// { 3, 7, 5, 6, 2 };
	int arr2[] = { 4, 5, 6};
	int arr3[] = { 9, 8, 9 };
	//char arr4[] = { '1', '1', '0', '0', '0' }; 
	char arr5[] = { '0', '0', '0', '0', '0' };  
	vector<int> number1(arr1, arr1 + sizeof(arr1) / sizeof(int));    
	vector<int> number2(arr2, arr2 + sizeof(arr2) / sizeof(int));
	vector<int> number3(arr3, arr3 + sizeof(arr3) / sizeof(int));
	//vector<char> number4(arr4, arr4 + sizeof(arr4) / sizeof(char));   
	vector<char> number5(arr5, arr5 + sizeof(arr5) / sizeof(char)); 
	vector < vector<int>> numbers = { number1 ,number2,number3};
	TimeConversion calc("12:45:54PM");      
	//countGroups(numbers); 
	//int arr = 4;
	...
	vector<int> numbers2(arr2, arr2 + sizeof(arr2) / sizeof(int));
