...
#undef main 
int main() { 
	int arr1[] = { 5, 2, 2, 1,5,3,2 };// { 3, 7, 5, 6, 2 };
	char arr2[] = { '1', '1', '0', '1', '0' }; 
	char arr3[] = { '1', '1', '0', '0', '0' };
	//char arr4[] = { '1', '1', '0', '0', '0' }; 
	char arr5[] = { '0', '0', '0', '0', '0' }; 
	vector<int> number1(arr1, arr1 + sizeof(arr1) / sizeof(int));
	vector<char> number2(arr2, arr2 + sizeof(arr2) / sizeof(char)); 
	vector<char> number3(arr3, arr3 + sizeof(arr3) / sizeof(char));
	//vector<char> number4(arr4, arr4 + sizeof(arr4) / sizeof(char));  
	vector<char> number5(arr5, arr5 + sizeof(arr5) / sizeof(char));
	//vector < vector<char>> numbers = { number1 ,number2,number3,number5};
	vectorArithmetics calc;
	calc.iotaCalculator(10,-2);
	//countGroups(numbers); 
	//int arr = 4;
